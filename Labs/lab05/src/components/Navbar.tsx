...
const Navbar = () => {
    ...
    return (
        <div className="text-white/70 pt-6">
            ...
            <div
                onClick={toggleNav}
                className="md:hidden absolute top-5 right-5 border rounded text-white/70 border-white/70 p-2 z-50 cursor-pointer"
            >
            ...
            <motion.div
                ...
                className="fixed left-0 top-0 w-full z-40 bg-black/90 h-screen"
            >
