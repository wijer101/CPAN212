...
function Profile({ userData, clearUserData }) {
  if (!userData) {
    return (
      <div className="container no-data">
        <Navbar />
        <p>No data available. Please enter your health information on the Dashboard.</p>
        <Link to="/dashboard">
  ...
  const formattedHeight = userData.heightUnit === 'cm'
    ? `${userData.height} cm`
  ...
  return (
    <div className="container">
      ...
      <button onClick={clearUserData} style={styles.clearButton}>Clear Profile</button>
    </div>
  );
}
